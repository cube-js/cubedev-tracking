(function () {
	...
	const track = async (event) => {
	  debugger
	  if (!componentCookie(COOKIE_ID)) {
	    setCookie(COOKIE_ID, v4_1(), { domain: COOKIE_DOMAIN, maxage: MAX_AGE, sameSite: 'None', secure:true });
	  }
	  trackEvents.push({
	    ...baseProps,
	    ...event,
	    ...
	    ...window.location,
	    id: v4_1(),
	    clientAnonymousId: componentCookie(COOKIE_ID),
